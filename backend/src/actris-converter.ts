...
export default function(file: File) {
	...
	return {
		"md_metadata": { // mandatory
			...
			"datestamp": file.createdAt, // mandatory
			"contact": [{ // mandatory
		...
		"md_keywords": { // mandatory
			"keywords": ["FMI", "ACTRIS", file.type] // mandatory, limit on 60 character keyword
		},
		...
		"md_actris_specific": { // mandatory
			...
			"product_type": file.type == CloudnetFileType.MODEL ? "model" : "observation", // mandatory ["model", "observation", "fundamental_parameter"]
			"matrix": "cloud", // mandatory ["cloud", "gas", "particle", "met"]
			"sub_matrix": "pm10", // mandatory
			"instrument_type": [(file.level == 2) || (file.type == CloudnetFileType.MODEL) ? "UNKNOWN" : file.type], // mandatory
